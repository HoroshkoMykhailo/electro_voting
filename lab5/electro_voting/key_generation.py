...
def generate_common_modulus_and_keys(num_voters=5):
    """
    Генерує загальний модуль n та пари ключів для всіх виборців.
    """
    primes = [p for p in range(2000, 5000) if is_prime(p)]
